# Rocket Engine for Physics Class: Proposal
...
# Rocket Engine for Physics Class: Notes
- Attempting to braze the copper pipes into something that resembles an engine has been difficult, between not having class time and being occupied with track meets, the process has taken longer than expected.
- First attempt at brazing: It's still difficult, we may need to go hotter than what our propane torch allows for. The plumber in the YouTube tutorial we watched made it look easy. Our local expert (Mr. Allen) hasn't been of significant help either, although we suspect this may be due to the lackluster competence of his offspring's communication skills, and not his aptitude. We suspect our school's Facilities Manager may be able to provide us with guidance instead.
